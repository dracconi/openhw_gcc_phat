...
entity gcc_phat_fft_fft_params_s is
    generic (
...
architecture arch of gcc_phat_fft_fft_params_s is
    --------------------- Component ---------------------
    component gcc_phat_fft_fft_params_s_core_ip is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component gcc_phat_fft_fft_params_s_core_ip
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
