...
entity gcc_phat_fifo_w16_d2_S is 
    generic (
...
architecture rtl of gcc_phat_fifo_w16_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component gcc_phat_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_gcc_phat_fifo_w16_d2_S_ShiftReg : gcc_phat_fifo_w16_d2_S_ShiftReg
    generic map (
...
entity gcc_phat_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end gcc_phat_fifo_w16_d2_S_ShiftReg;

architecture rtl of gcc_phat_fifo_w16_d2_S_ShiftReg is
