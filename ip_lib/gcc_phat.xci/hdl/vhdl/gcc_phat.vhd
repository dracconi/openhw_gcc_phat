...
architecture behav of gcc_phat is 
    ...
    "gcc_phat_gcc_phat,hls_ip_2025_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7s50-csga324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.203000,HLS_SYN_LAT=34951,HLS_SYN_TPT=34952,HLS_SYN_MEM=23,HLS_SYN_DSP=0,HLS_SYN_FF=26467,HLS_SYN_LUT=22651,HLS_VERSION=2025_1}";
